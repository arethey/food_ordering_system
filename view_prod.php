...
<div class="container-fluid">
    ...
    <div class="card " style="border-color: #f4623a;">
    ...
    class="fa fa-plus"></span></button>
            ...
            <div class="text-center">
                ...
                <a href="index.php?page=reviews&id=<?php echo $_GET['id']; ?>" class="btn btn-outline-primary btn-sm btn-block">View Reviews</a>
            </div>
        </div>

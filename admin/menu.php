                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <tbody id="myTable">
                                <?php
								$i = 1;
								$cats = $conn->query("SELECT *, product_list.id as pId, product_list.name as prodName FROM product_list order by product_list.id asc");
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        ...
                                        <p>Stocks : <b><?php echo $row['stocks'] ?> kgs.</b></p>
                                    </td>
                                    <td class="text-center">

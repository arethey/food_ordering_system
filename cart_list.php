     ...
     <div class="container h-100">
         <div class="row h-100 align-items-center justify-content-center text-center">
             <div class="col-lg-10 align-self-end mb-4 page-title" style="background:transparent;">
                 <h3 class="text-uppercase text-white font-weight-bold" style="font-size: 55px">Cart List</h3>
             ...
             <div class="col-lg-8">
                 <div class="sticky">
                     <div class="card">
                         <div class="card-body">
                             <div class="row">
                                 <div class="col-md-8"><b>My Cart</b></div>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-4">
                                 ...
                                 <div class="input-group mb-3">
                                     ...
                                     <input type="text" value="<?php echo $row['qty'] ?>" min=1
